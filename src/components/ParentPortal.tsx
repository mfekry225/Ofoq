            ...
            <div className="bg-white border border-sky-100 rounded-3xl p-5 sm:p-6 shadow-xs space-y-4">
              ...
              {(student.diagnosis || student.birthDate || student.address) && (
                <div className="flex flex-wrap items-center gap-2 pt-1">
                  {student.diagnosis && (
                    <span className="px-2.5 py-1 rounded-xl bg-rose-50 border border-rose-200 text-rose-800 text-[11px] font-bold flex items-center gap-1.5">
                  ...
                  {student.birthDate && (
                    <span className="px-2.5 py-1 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-800 text-[11px] font-bold flex items-center gap-1.5">
                  ...
                  {student.address && (
                    <span className="px-2.5 py-1 rounded-xl bg-slate-100 border border-slate-200 text-slate-700 text-[11px] font-medium flex items-center gap-1.5">
